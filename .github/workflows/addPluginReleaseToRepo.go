...
func main() {
	...
	repo := repoFileFor(pluginReleaseEvent.Version)
	pluginsJson, pluginsJsonReadErr := ioutil.ReadFile(repo)
	...
	pluginsJsonWriteErr := ioutil.WriteFile(repo, indentBuffer.Bytes(), 0644)
